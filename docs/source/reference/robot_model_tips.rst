...
Controls which rotational degrees of freedom are constrained:
...
.. code-block:: python
    ...
    robot.inverse_kinematics(target, rotation_mask='xy')   # Roll and pitch only
    robot.inverse_kinematics(target, rotation_mask='z')    # Only yaw
    robot.inverse_kinematics(target, rotation_mask='xz')   # Roll and yaw

**Supported rotation mask values:**

- ``True``: Constrain all rotation axes (roll, pitch, yaw)
- ``False`` or ``None``: No rotation constraint
- ``'x'``, ``'y'``, ``'z'``: Constrain only the specified rotation axis
- ``'xy'``, ``'yz'``, ``'xz'``: Constrain the two specified rotation axes
- ``[1, 1, 0]``: Direct mask specification (constrain roll and pitch)
...
**Single Axis Rotation with Full Position**
...
.. figure:: ../_static/ik_single_rot_rot_x_trans_full.png
   ...
   **Roll Only (X-axis Rotation)**
   ...
   ``rotation_mask='x', position_mask=True``
...
.. figure:: ../_static/ik_single_rot_rot_y_trans_full.png
   ...
   **Pitch Only (Y-axis Rotation)**
   ...
   ``rotation_mask='y', position_mask=True``
...
.. figure:: ../_static/ik_single_rot_rot_z_trans_full.png
   ...
   **Yaw Only (Z-axis Rotation)**
   ...
   ``rotation_mask='z', position_mask=True``

**Double Axis Rotation with Full Position**
...
.. figure:: ../_static/ik_double_rot_rot_xy_trans_full.png
   ...
   **Roll + Pitch (XY-axes Rotation)**
   ...
   ``rotation_mask='xy', position_mask=True``
...
.. figure:: ../_static/ik_double_rot_rot_yz_trans_full.png
   ...
   **Pitch + Yaw (YZ-axes Rotation)**
   ...
   ``rotation_mask='yz', position_mask=True``
...
.. figure:: ../_static/ik_double_rot_rot_zx_trans_full.png
   ...
   **Yaw + Roll (ZX-axes Rotation)**
   ...
   ``rotation_mask='zx', position_mask=True``
...
Common combinations of position and rotation constraints for specific applications:
...
.. figure:: ../_static/ik_mixed_planar_yaw.png
   ...
   **Planar Motion + Yaw Control**
   ...
   ``rotation_mask='z', position_mask='xy'``
...
.. figure:: ../_static/ik_mixed_vertical_tilt.png
   ...
   **Vertical Motion + Tilt Control**
   ...
   ``rotation_mask='xy', position_mask='z'``
...
.. figure:: ../_static/ik_mixed_frontal_plane.png
   ...
   **Frontal Plane Motion**
   ...
   ``rotation_mask='x', position_mask='yz'``
